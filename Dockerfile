...
# Disable threaded MPM modules — PHP is compiled for mpm_prefork (non-threadsafe)
# and will crash Apache with "not compiled to be threadsafe" if a threaded MPM is loaded
